    ...
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-purple-100">
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-6 flex-1 overflow-y-auto w-full">
          <div className="bg-white rounded-2xl shadow-xl border border-purple-50">
            <div className="px-6 py-3 border-b border-purple-50 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text">
              <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                ...
                <div className="flex flex-wrap md:flex-nowrap items-center gap-3 w-full md:w-auto">
                  <select
                    ...
                    className="h-9 px-3 border border-purple-200 rounded-md text-sm bg-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none flex-grow md:flex-grow-0 max-w-64"
                  >
                  ...
                  <DatePicker
                    ...
                    className="h-9 px-3 border border-purple-200 rounded-md text-sm focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none w-full max-w-64"
                  />
                  ...
                  {userJourneyLoading ? (
                    Array.from({ length: itemsPerPage }).map((_, index) => (
                      <tr key={index} className="animate-pulse">
                        <td className="px-4 py-2"><div className="h-3 bg-purple-100 rounded"></div></td>
                        <td className="px-4 py-2"><div className="h-3 bg-purple-100 rounded"></div></td>
                        <td className="px-4 py-2"><div className="h-3 bg-purple-100 rounded"></div></td>
                        <td className="px-4 py-2"><div className="h-3 bg-purple-100 rounded w-3/4"></div></td>
                        <td className="px-4 py-2"><div className="h-3 bg-purple-100 rounded"></div></td>
                      </tr>
                    ))
                    ...
                    <tr key={index} className="hover:bg-purple-50 transition-colors">
                      ...
                      <td className="px-4 py-2">
                        <span className="px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-gradient-to-r from-blue-50 to-purple-50 text-purple-800">
            ...
            <div className="px-4 py-3 border-t border-purple-50 flex flex-col sm:flex-row justify-between items-center gap-3">
              <div className="flex items-center gap-2">
                <span className="text-xs text-purple-600">Show:</span>
                <select
                  value={itemsPerPage}
                  onChange={(e) => {
                  ...
                  className="h-8 px-2 border border-purple-200 rounded-md text-xs bg-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none"
                >
                  {[10, 25, 50].map((size) => (
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="px-2 py-1 border border-purple-200 rounded-md hover:bg-purple-50 disabled:opacity-50 transition-colors text-xs"
                >
                  ← Prev
                </button>
