                    ...
                    <div className=" bg-white rounded-xl shadow-lg overflow-hidden">
                        <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-6">
                            <div className="flex justify-between items-center">
                                <h1 className="text-2xl font-bold text-white">Fleets Management</h1>
                                <button
                                ...
                                <table className="min-w-full">
                                    <thead>
                                        <tr className="border-b border-gray-200">
                                            <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Fleet Name</th>
                                            <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Status</th>
                                            <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Select</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {fleetsLoading ? (
                                            ...
                                            fleetData().map((fleet: any) => (
                                                <tr key={fleet.id} className="border-b border-gray-100 hover:bg-gray-50">
                                                    <td className="py-4 px-4">
